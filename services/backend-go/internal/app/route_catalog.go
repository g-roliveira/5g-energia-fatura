					...
					"examples": map[string]any{
						"default": map[string]any{
							"value": map[string]any{
								...
								"fator_repasse_energia":                  "0.30",
								"valor_ip_com_desconto":                  "13.35",
	...
	return map[string]any{
		...
		"schemas": map[string]any{
			...
			"BillingContractCreateRequest": map[string]any{
				"type":     "object",
				"required": []string{"customer_id", "consumer_unit_id", "vigencia_inicio", "fator_repasse_energia"},
				"properties": map[string]any{
					...
					"fator_repasse_energia":                  map[string]any{"type": "string", "description": "Decimal no intervalo (0,1], ex.: 0.30"},
					"valor_ip_com_desconto":              map[string]any{"type": "string", "description": "Valor contratual da IP no cenario COM repasse"},
			...
			"BillingContractView": map[string]any{
				"type":     "object",
				"required": []string{"id", "customer_id", "consumer_unit_id", "vigencia_inicio", "fator_repasse_energia", "ip_faturamento_mode", "status", "created_at", "updated_at"},
				"properties": map[string]any{
					...
					"fator_repasse_energia":                  map[string]any{"type": "string"},
					"valor_ip_com_desconto":              map[string]any{"type": "string"},
